        ...
        <div id="window" >
            ...
            <div id="pubmed_result_window" >
                ...
                if (isset($_POST['pubmed_Search'])) {
                    ...
                    $_SESSION["fromyear"] = $_POST["pub_from_year"];
                    $_SESSION["uptoyear"] = $_POST["pub_upto_year"];
                ...
                if ($action == 1.3) {
                    ...
                    $fromyearprog = $_SESSION["fromyear"];
                    $uptoyearprog = $_SESSION["uptoyear"];
                    session_start();
                    $id = session_id();
                    $output = shell_exec("python .\scripts\abs_min_max_graph.py $keyqueryprog $recqueryprog $fromyearprog $uptoyearprog $id  2>&1");   // Change the Python script path accordingly
                ...
                <div id="result">
                    <div id = "tabledesign">
                        ...
                        <table id = "pubmed_table_bottom" table border = "5" align = "justify"   class="table" >
                            <?php
                            $j = 1;
                            $k = 0;
                            $exact_rec = $arrresult / 10;
                            ?>
                            <div id = "result_panel">
                                <!--<span style="color:darkmagenta; font-size:18pt;">Congratulations!!!</span><br>-->
                            ...
                            for ($i = 0; $i < $exact_rec; $i++) {
                                ...
                                $k = $k + 1;
                                echo "<TR><TD ><b>Journal Identifier: </b>$result[$k]</TD></TR>";
                                $k = $k + 1;
                    ...
                    <form method='POST' action='pubmed_min_max_graph.php' enctype='multipart/form-data' id="form_glob_graph">
                        <button type="submit" value='pmminmaxgraphs' name="pmminmaxgraphs" id="pmminmaxgraphs" class="btn btn-primary">Evaluate</button>
                    </form>
                </div>
