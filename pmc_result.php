    ...
    <body id="BG1" style="text-align: center">
        ...
        <div id="window" >
            ...
            <div id="pmc_result_window" >
                ...
                $sortqueryprog = $_SESSION["sortquery"];
                #$pathqueryprog = $_SESSION["pathquery"];
                
                $output = shell_exec("python .\scripts\pmc_datamining.py $keyqueryprog $recqueryprog $dir $sortqueryprog 2>&1");   // Change the Python script path accordingly
                echo $output;
                ?>
