        ...
        <div id="window" >
            ...
            <div id="pub_jrl_yr_grph_window" >
                <div id="graph_table">
                    ...
                    $f = fopen(".//scripts//results_pubmed//abstract_mindate_maxdate_table1.csv", "r");
                    $fr = fread($f, filesize(".//scripts//results_pubmed//abstract_mindate_maxdate_table1.csv"));
                    fclose($f);
                    $lines = array();
                ...
                <div id="jrl_yr_graph1">
                    <img src="absminmax_fig.png" width="900" height="440">
                </div>
                <hr style="background: #0096CD; border:0; height:5px; width: 100%; " />
                <div id="graph_table">
                    <?Php
                    echo "<html><body><table border=2>";
                    $f = fopen(".//scripts//results_pubmed//abstract_mindate_maxdate_table2.csv", "r");
                    $fr = fread($f, filesize(".//scripts//results_pubmed//abstract_mindate_maxdate_table2.csv"));
                    fclose($f);
                    $lines = array();
                    $lines = explode("\n", $fr); // IMPORTANT the delimiter here just the "new line" \r\n, use what u need instead of... 
                ...
                <div id="jrl_yr_graph2">
                    <img src="absminmax_fig2.png" width="900" height="440">
                </div>
                <hr style="background: #0096CD; border:0; height:5px; width: 100%; " />
                <div id="graph_table">
                    <?Php
                    echo "<html><body><table border=2>";
                    $f = fopen(".//scripts//results_pubmed//abstract_mindate_maxdate_table3.csv", "r");
                    $fr = fread($f, filesize(".//scripts//results_pubmed//abstract_mindate_maxdate_table3.csv"));
                    fclose($f);
                    $lines = array();
                    $lines = explode("\n", $fr); // IMPORTANT the delimiter here just the "new line" \r\n, use what u need instead of... 
                ...
                <div id="jrl_yr_graph3">
                    <img src="absminmax_fig3.png" width="900" height="440">
                </div>
                <hr style="background: #0096CD; border:0; height:5px; width: 100%; " />
