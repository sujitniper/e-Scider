            ...
            <div id="pub_jrl_yr_grph_window" >
                <div id="graph_table">
                    ...
                    if (isset($_POST['graphs'])) {
                        $_SESSION["keyquery"] = $_POST["glob_key"];
                        #echo $_SESSION["dataquery"];
                    }
                    ?>
                    <?php
                    $glob = $_SESSION["keyquery"];
                    $glob = str_replace(" ", "+", $glob);
                    //echo $glob;
                    $output1 = shell_exec("python ./scripts/globe_graphs.py $glob 2>&1");
                    ?>

                    <?Php
                    echo "<html><body><table border=2>";
                    $f = fopen(".//scripts//results_pubmed//globe_table1.csv", "r");
                    $fr = fread($f, filesize(".//scripts//results_pubmed//globe_table1.csv"));
                    fclose($f);
                    $lines = array();
                ...
                <div id="jrl_yr_graph1">
                    <img src="glob_fig1.png" width="1000" height="440">
                </div>
                <hr style="background: #0096CD; border:0; height:5px; width: 100%; " />
                <div id="graph_table">
                    <?Php
                    echo "<html><body><table border=2>";
                    $f = fopen(".//scripts//results_pubmed//globe_table2.csv", "r");
                    $fr = fread($f, filesize(".//scripts//results_pubmed//globe_table2.csv"));
                    fclose($f);
                    $lines = array();
                    $lines = explode("\n", $fr); // IMPORTANT the delimiter here just the "new line" \r\n, use what u need instead of... 
                ...
                <div id="jrl_yr_graph2">
                    <img src="glob_fig2.png" width="900" height="440">
                    <br>
                    <img src="glob_fig3.png" width="900" height="440">
                </div>
                <hr style="background: #0096CD; border:0; height:5px; width: 100%; " />
                <div id="graph_table">
                    <?Php
                    echo "<html><body><table border=2>";
                    $f = fopen(".//scripts//results_pubmed//globe_table3.csv", "r");
                    $fr = fread($f, filesize(".//scripts//results_pubmed//globe_table3.csv"));
                    fclose($f);
                    $lines = array();
                    $lines = explode("\n", $fr); // IMPORTANT the delimiter here just the "new line" \r\n, use what u need instead of... 
                ...
                <div id="jrl_yr_graph3">
                    <img src="glob_fig4.png" width="900" height="440">
                </div>
                <hr style="background: #0096CD; border:0; height:5px; width: 100%; " />
