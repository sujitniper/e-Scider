...
<html>
    ...
    <body id="BG1" style="text-align: center">
        ...
        <div id="window" >
            ...
            <div id="develop_window" >
                <div id="contact1" >
                    <div id="image1">
                        <img src="images/PG.jpg" alt="Dr. Prabha Garg" width="100" height="125" style="display: block">
                    </div>      
                    <div id="details1">
                        <span style="color: #000; font:  sans-serif;font-size: 16pt; font-weight: bold">Under the supervision of :</span>
                        <br/><span style="color: #004E46; font:  sans-serif;font-size: 14pt;font-weight: bold">Dr. Prabha Garg</span><br/>Professor,<br/>Dept. of Pharmacoinformatics,<br/>NIPER, Mohali - INDIA <br/>Email ID: <a href="mailto:prabhagarg@niper.ac.in">prabhagarg@niper.ac.in</a>
                    </div>
                </div>
                ...
                <div id="contact2" >
                    <div id="image2">
                        <img src="images/Sujit.jpg" alt="Sujit R. Tangadpalliwar" width="100" height="125" style="display: block">
                    </div>
                    <div id="details2">
                        <div>
                            <span style="color: #000; font:  sans-serif;font-size: 16pt; font-weight: bold">Developed by :</span>
                         <br/><span style="color: #004E46; font:  sans-serif;font-size: 14pt;font-weight: bold">Sujit R. Tangadpalliwar</span><br/>Doctoral Student,<br/>Dept. of Pharmacoinformatics,<br/>NIPER, Mohali, INDIA<br/>Email ID: <a href="mailto:sujit_14pip386@niper.ac.in">sujit_14pip386@niper.ac.in</a>
                        </div>
                    </div>
                </div>
            </div>
